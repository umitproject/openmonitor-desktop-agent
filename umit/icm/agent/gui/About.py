...
class About(HIGWindow):
    ...
    def __create_widgets(self):
        ...
        self.lbl_program_version = gtk.Label(
            "<span size='20000' weight='heavy'>Umit ICM Agent</span>")
...
Main function developed by Alan Wang, UI developed by Paul Pei
and was sponsered by Google during the
Summer of Code in 2011. Thanks Google!""")

        self.lbl_copyright=gtk.Label(
            "<small>Copyright (C) 2011 Adriano Monteiro Marques</small>")
        ...
        self.btn_close.set_size_request(60,30)
    ...
    def __packing(self):
        ...
        self.fix = gtk.Fixed()
        self.fix.put(self.btn_close, 155, 5)
        #self.hbox.add(self.fix)
        self.vbox._pack_expand_fill(self.fix)
